...
class ConditionalQueryFNP(nn.Module):
    def __init__(self, args):
        ...
        # if args.encoder == 'NP':
        #     self.encoder = ConditionalNPEncoder(args)
        # elif args.encoder == 'Conv':
        #     self.encoder = UnconditionalConvEncoder(args)
        # elif args.encoder == 'ResConv':
        #     self.encoder = UnconditionalConvEncoder2(args)
        self.encoder = UnconditionalConvEncoder(args)
